                    ...
                    <div class="tab-content">
                            ...
                            <div class="col-md-6">
                                <div class="mb-7 bg-light p-3 rounded h-100">
                                    <div class="card-title fw-bold">
                                        ...
                                        <p class="m-0">{{ $newsletter->email }}</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-7 bg-light p-3 rounded h-100">
                                    <div class="card-title fw-bold">
                                        <h5 class="font-weight-bolder text-dark">@lang('general.newsletter'):</h5>
                                        <p class="m-0">{{ $newsletter->newsletter }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
