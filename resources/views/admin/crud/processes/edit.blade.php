                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        <h5>{{ __('general.edit') }} {{ __('general.processes') }}</h5>
                                    </div>
                                            ...
                                            <div class="tab-pane fade show @if ($key == 0) active @endif"
                                                ...
                                                <div class="mb-4 row align-items-center"> <label
                                                    ...
                                                    <div class="col-sm-9"> <input type="text"
                                                            ...
                                                            value="{{ old($locale . '.title', $process->translate($locale)->title) }}"> </div>
                                                </div>
                                                ...
                                                <div class="mb-4 row align-items-center"> <label
                                                    ...
                                                    <div class="col-sm-9"> <input type="text"
                                                            ...
                                                            value="{{ old($locale . '.subtitle', $process->translate($locale)->subtitle) }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-4 row align-items-center"> <label
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea rows="100" class="summernote @error($locale . '.description') is-invalid @enderror"
                                                            name="{{ $locale . '[description]' }}"> {!! old($locale . '.description', $process->translate($locale)->description) !!} </textarea>
                                                    </div>
                                                </div>
