                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-5 bg-light p-3 rounded h-100">
                                            <div class="card-title fw-bold">
                                                ...
                                                <p style="margin: 0; color: inherit; font-weight: normal;">{{ $service->translate($locale)->title }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-5 bg-light p-3 rounded h-100">
                                            <div class="card-title fw-bold">
                                                ...
                                                <p style="margin: 0; color: inherit; font-weight: normal;">{{ $service->translate($locale)->subtitle }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-5 bg-light p-3 rounded h-100">
                                            <div class="card-title fw-bold">
                                                ...
                                                <p style="margin: 0; color: inherit; font-weight: normal;">{!! $service->translate($locale)->description !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
