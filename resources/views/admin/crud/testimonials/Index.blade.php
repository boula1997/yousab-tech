                            ...
                            <div class="card-header">
                                ...
                                <div class="row">
                                    <div class="col-md-6 d-flex d-flex justify-content-start">
                                        <h3 class="card-title">@lang('general.testimonials')</h3>
                                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{ route('testimonials.destroy', $testimonial) }}" method="POST">
                                                        <a href="{{ route('testimonials.show', $testimonial) }}" title="show">
                                                            <i class="fas fa-eye text-secondary fa-lg"></i>
                                                        </a>

                                                        <a href="{{ route('testimonials.edit', $testimonial) }}" title="edit">
