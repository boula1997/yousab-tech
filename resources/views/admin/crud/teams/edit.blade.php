                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="title-header option-title">
                                        <h5>{{ __('general.edit') }} {{ __('general.teams') }}</h5>
                                    </div>
                                                ...
                                                <div class="mb-4 row align-items-center"> <label
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea rows="100" class="summernote @error($locale . '.description') is-invalid @enderror"
                                                            name="{{ $locale . '[description]' }}"> {!! old($locale . '.description', $team->translate($locale)->description) !!} </textarea>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="mb-4 row align-items-center"> <label
                                        ...
                                        <div class="col-sm-9"> <input type="text" name="facebook"
                                                ...
                                                value="{{ old('facebook', $team->facebook) }}"> </div>
                                    </div>
                                    ...
                                    <div class="mb-4 row align-items-center"> <label
                                        ...
                                        <div class="col-sm-9"> <input type="text" name="twitter"
                                                ...
                                                value="{{ old('twitter', $team->twitter) }}"> </div>
                                    </div>
                                    ...
                                    <div class="mb-4 row align-items-center"> <label
                                        ...
                                        <div class="col-sm-9"> <input type="text" name="instagram"
                                                ...
                                                value="{{ old('instagram', $team->instagram) }}"> </div>
                                    </div>
                                    ...
                                    <div class="mb-4 row align-items-center"> <label
                                        ...
                                        <div class="col-sm-9"> <input type="text" name="linkedin"
                                                ...
                                                value="{{ old('linkedin', $team->linkedin) }}"> </div>
                                    </div>
                                    ...
                                    <div class="mb-4 row align-items-center"> <label
                                        ...
                                        <div class="col-sm-9"> <input type="datetime-local" id="dateTimeInput"
                                                ...
                                                value="{{ old('created_at', $team->created_at) }}" name="created_at">
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-4 row align-items-center"> <label
                                        ...
                                        <div class="col-sm-9"> <input type="datetime-local" id="dateTimeInput"
                                                ...
                                                value="{{ old('updated_at', $team->updated_at) }}" name="updated_at">
                                        </div>
                                    </div>
