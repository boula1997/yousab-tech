        ...
        <div class="container p-3">
            <div class="card card-custom card-stretch gutter-b">
                <div class="card-header card-header-tabs-line">
                    @include('admin.components.breadcrumb', ['module' => 'complains', 'action' => 'show'])
                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-7 bg-light p-3 rounded h-100">
                                            <div class="card-title fw-bold">
                                                ...
                                                <p class="m-0">{{ $complain->translate($locale)->title }}</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-7 bg-light p-3 rounded h-100">
                                            <div class="card-title fw-bold">
                                                ...
                                                <p class="m-0">{!! $complain->translate($locale)->description !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
