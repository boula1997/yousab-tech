...
<head>
    ...
    <meta name="x-apple-disable-serviceRequest-reformatting">  <!-- Disable auto-scale in iOS 10 Mail entirely -->
            	...
            	<tr>
            		<td>
            			<div class="text" style="padding: 0 2.5em; text-align: center;">
                            ...
                            {{-- <a class="btn btn-black mt-3" href="{{route('front.serviceRequest')}}">{{ __('general.visit_our_website') }}</a> --}}
