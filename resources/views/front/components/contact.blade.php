<div class="row">
    ...
    <div class="col-lg-4 mb-4 contact-right">
        ...
        <p>{{ $setting->phone2 }}</p>
        <a href="https://wa.me/966537394580"><i style="font-size:3%"class="fab fa-whatsapp"></i></a> <a href="tel:00966537394580"><i style="font-size: 3%" class="fas fa-phone-square"></i></a>
