    ...
    */
    ...
    'attributes' => [
        ...
        "ar"=>[
            ...
            "service_id" => "Service in Arabic",
            "slider_id" => "Slider in Arabic",
            "counter_id" => "Counter in Arabic",
            "role_id" => "Role in Arabic",
            "page_id" => "Page in Arabic",
            "tokenable_id" => "Tokenable in Arabic",
            "gallery_id" => "Gallery in Arabic",
            "blog_id" => "Blog in Arabic",
            ...
            "appointment2" => "Appointment2 in Arabic",
        ...
        "en"=>[
            ...
            "service_id" => "Service in English",
            "slider_id" => "Slider in English",
            "counter_id" => "Counter in English",
            "role_id" => "Role in English",
            "page_id" => "Page in English",
            "tokenable_id" => "Tokenable in English",
            "gallery_id" => "Gallery in English",
            "blog_id" => "Blog in English",
            ...
            "meta_data" => "Meta_data in English",
            ...
            "appointment2" => "Appointment2 in English",
